...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ico-5di.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ico-5di.containers.anotherwebservice.com/
...
```
git clone git@github.com:ryushinmd/container-ico-5di.git
cd container-ico-5di
```
...
```
docker attach container-ico-5di
```
